  ...
  return (
    <div className="animate-fadein">
      <div
        ...
        className="fixed inset-0 z-50 flex h-screen w-full items-end justify-center bg-stone-950/50 sm:items-center"
      >
        <div
          id="popup-confirm"
          className="w-full bg-rose-50 p-5 sm:w-1/3 sm:min-w-[400px] sm:max-w-[520px] sm:rounded-lg"
        >
          <svg
            width="48"
            height="48"
          ...
          <p className="mt-4 text-3xl font-bold">Order Confirmed</p>
          <p className="mt-1 text-sm text-rose-500">
            we hope you enjoy your food
          </p>
          <div className="mt-5 w-full rounded-md bg-rose-100 p-3">
