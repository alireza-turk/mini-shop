...
function CartContainer({ setStatePopupConfirm }) {
  const { cartItems } = useCart()

  return (
    <div className="flex flex-col items-center gap-3 rounded-lg bg-rose-50 p-5">
      <p className="self-start text-xl font-bold text-red">
      ...
      {cartItems.length !== 0 ? (
        <div className="w-full">
          ...
          <div className="mt-4 flex items-center justify-center gap-2 rounded bg-rose-100 px-3 py-4">
            <svg
          ...
          <Button onClick={() => setStatePopupConfirm(true)}>
            Confirm Order
          </Button>
        </div>
      ) : (
        <>
          ...
          >
            ...
            />
            <path stroke="#fff" d="m81.076 28.966 34.187-4.16" />
            <path
              fill="#87635A"
